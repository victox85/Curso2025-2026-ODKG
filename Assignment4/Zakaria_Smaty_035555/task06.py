...
Original file is located at
    https://colab.research.google.com/drive/1x3Q-ylxwzftteOh9kcnuR124mt2JYfTT
...
#definimos la jerarquia/relacion
...
# añadimos atributos a Oscar
g.add((person.Oscar, VCARD.Given, Literal("Óscar")))
g.add((person.Oscar, VCARD.Family, Literal("Corcho García")))
