...
Original file is located at
    https://colab.research.google.com/drive/1YgFusQmkAAIrtkAONZpYvjIGB-pQHBtW
...
# The hierarchy is built using rdfs:subClassOf triples.
...
g.add((ontology.hasName, RDFS.range, RDFS.Literal)) # Range is a literal value

# hasColleague property
...
g.add((ontology.hasColleague, RDFS.range, ontology.Person)) # Range is another Person
...
g.add((ontology.hasHomePage, RDFS.range, RDFS.Literal)) # Range is a literal value (URL)
...
# Oscar: añadir Given, Family y email (task 6.4)
...
g.add((person.Oscar, FOAF.email,  Literal("ocorcho@example.org", datatype=XSD.string)))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
