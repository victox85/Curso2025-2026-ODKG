...
Original file is located at
    https://colab.research.google.com/github/AlexFerroni02/Curso2025-2026-ODKG/blob/assignment-4/Assignment4/course_materials/notebooks/Task07.ipynb
...
SELECT ?name ?type
WHERE {
  ?person people:knows people:Rocky .   # chi conosce Rocky
